# [Unsupervised Image Anomaly Detection and Segmentation Based on Pre-trained Feature Mapping](https://ieeexplore.ieee.org/document/xxx)

## Abstract

### [PFM (TII)](https://ieeexplore.ieee.org/document/xxx)
...
### [PEFM (CASE)](https://ieeexplore.ieee.org/document/xxx)
